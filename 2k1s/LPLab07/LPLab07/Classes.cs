...
namespace LPLab07
{
    abstract partial class ControlElement
    {
        ...
        {
            if (x < 0 || y < 0) throw new CoordsParameterControlElementException(x, y);
            xPos = x;
            yPos = y;
        }
    ...
    class Rectangle : ControlFigure
    {
        ...
        {
            if (size <= 0) throw new WidthParameterControlElementException(size);
            width = size;
        }
    ...
    class Circle : ControlFigure
    {
        ...
        {
            if (radius <= 0) throw new RadiusParameterControlElementException(newRad);
            radius = newRad;
        }
        ...
        {
            string rstr = "";
            rstr += $"X-pos = {xPos}, Y-pos = {yPos}, border = {border}, value = {value}, color = {color.ToString("X2")}, shape = circle, radius = {radius}.";
            return rstr;
        }
    }
    ...
    sealed class CheckBox : Rectangle, IControl
    {
        ...
        {
            string rstr = "";
            rstr += $"X-pos = {xPos}, Y-pos = {yPos}, border = {border}, value = {value}, color = {color.ToString("X2")}, shape = rectangle, width = {width}, flag = {flag}.";
            return rstr;
        }
    }
    ...
    sealed class RadioButton : Button
    {
        ...
        {
            if (newRad <= 0) throw new RadiusParameterControlElementException(newRad);
            if (newInnerRad < 0) throw new RadiusParameterControlElementException(newInnerRad);
        ...
        {
            string rstr = "";
            rstr += $"X-pos = {xPos}, Y-pos = {yPos}, border = {border}, value = {value}, color = {color.ToString("X2")}, shape = circle, radius = {radius}, innerRad = {innerRadius}, flag = {flag}.";
            return rstr;
        }
    }
}
